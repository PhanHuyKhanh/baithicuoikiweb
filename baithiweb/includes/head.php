                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="contact.php">Kết Nối</a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div style="display: flex; align-items: center;">
                                        <div class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown_3">
                                                <a class="dropdown-item" href="allorders.php">Đơn Hàng</a>
                                                <a class="dropdown-item" href="tracking.php">Theo Dõi Đơn Hàng</a>
                                                <a class="dropdown-item" href="scripts/logout_script.php">Đăng Xuất</a>
                                            </div>
                                        </div>
                                        <div>
