      ...
      <div class="col-lg-8">
        <div class="breadcrumb_iner">
          <div class="breadcrumb_iner_item">
            ...
            <p>Trang chủ <span>-</span> Đơn nhà hàng</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="billing_details">
      <div class="row">
        <form class="row contact_form" action="confirmation.php" method="post" novalidate="novalidate">
          <div class="col-lg-8">
            <h3>Chi tiết thanh toán/giao hàng</h3>
            ...
            <div class="col-md-8 form-group p_star">
              ...
              <span class="placeholder" data-placeholder="Địa chỉ 01"></span>
            </div>
            <div class="col-md-8 form-group p_star">
              <input type="text" class="form-control" id="add2" name="add2" />
              <span class="placeholder" data-placeholder="Địa chỉ 02"></span>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="order_box">
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  '<li>
                    <a href="#">
                      ...
                      <span class="last">' . $row['qty'] * $row['price'] . ' đ</span>
                    </a>
                  </li>';
              ...
              <ul class="list list_2">
                <li>
                  <a href="#">Tổng tiền
                    <span><?php echo $sum ?> đ</span>
                  </a>
                </li>
                <li>
                  <a href="#">Phí(15000 đ/sản phẩm)
                    <span><?php echo $quantity * 15000 ?> đ</span>
                  </a>
                </li>
                <li>
                  <a href="#">Thành tiền
                    <span><?php echo $sum + 15000 * $quantity ?> đ</span>
                  </a>
                </li>
              </ul>
              <br><br>
