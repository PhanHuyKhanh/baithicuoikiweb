            ...
            <div class="col-lg-8">
                <div class="breadcrumb_iner">
                    <div class="breadcrumb_iner_item">
                        ...
                        <p>Trang chủ <span>-</span> Mua nhiều sản phẩm</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <aside class="left_widgets p_filter_widgets">
                        ...
                        <div class="widgets_inner">
                            <ul class="list">
                                ...
                                <li>
                                    <a href="#">Phở tái bắp</a>
                                    <span>(6)</span>
                                </li>
                                <li>
                                    <a href="#">Phở nạm gầu</a>
                                    <span>(6)</span>
                                </li>
                                <li>
                                    <a href="#">Mì xào</a>
                    ...
                    <div class="col-lg-12">
                        <div class="product_top_bar d-flex justify-content-between align-items-center">
                            <div class="single_product_menu">
                                <p><span><?php echo $sum ?> </span> sản phẩm được tìm thấy</p>
                            </div>
                ...
                <div class="row align-items-center latest_product_inner">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        if (!check_if_added_to_cart($row['id'])) {
                            echo '<a href="scripts/cart_add.php?id=' . $row['id'] . '&qty=1" class="add_cart">+ thêm vào giỏ<i class="ti-heart"></i></a>';
                        } else {
                            echo '<a href="#" class="add_cart" disabled>+ Thêm vào giỏ<i class="ti-heart"></i></a>';
                        }
