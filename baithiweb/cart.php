        ...
        <div class="cart_inner">
            <div class="table-responsive">
                ...
                <div class="checkout_btn_inner float-right">
                    <a class="btn_1" href="category.php">Tiếp tục mua</a>
                    <a class="btn_1 checkout_btn_1" href="checkout.php">Tiến hành thanh toán</a>
                </div>
            </div>
        </div>
</section>
