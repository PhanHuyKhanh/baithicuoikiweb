            ...
            <div class="col-lg-8">
                <div class="breadcrumb_iner">
                    <div class="breadcrumb_iner_item">
                        ...
                        <p>Trang chủ <span>-</span> Kết nối với chúng tôi</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input class="form-control" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập tên của bạn'" placeholder="Nhập tên của bạn" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input class="form-control" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập địa chỉ email của bạn'" placeholder="Nhập địa chỉ email của bạn" />
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
            ...
            <div class="col-lg-4">
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3>Số 04 Bạch Đằng, Phường
                            Thạch Thang, Q. Hải Châu, TP.
                            Đà Nẵng</h3>
                        <p>Nhà hàng VKU</p>
                    </div>
                </div>
                ...
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3>
                            <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="32414742425d404672515d5e5d405e5b501c515d5f">[email&#160;được bảo vệ]</a>
                        </h3>
