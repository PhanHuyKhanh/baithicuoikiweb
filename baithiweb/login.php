            ...
            <div class="col-lg-8">
                <div class="breadcrumb_iner">
                    <div class="breadcrumb_iner_item">
                        <h2>Đăng nhập</h2>
                        <p>Trang chủ <span>-</span> Đăng nhập người dùng</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="login_part_text text-center">
                    <div class="login_part_text_iner">
                        <h2>Bạn mới đến nhà hàng của chúng tôi?</h2>
                        <p>
                        ...
                        <a href="register.php" class="btn_3">Tạo một tài khoản</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="login_part_form">
                    <div class="login_part_form_iner">
                        <h3>
                            Chào mừng bạn đã trở lại ! <br /> Vui lòng đăng nhập ngay
                        </h3>
