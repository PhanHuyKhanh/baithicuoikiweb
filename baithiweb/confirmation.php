...
while ($row = mysqli_fetch_array($result)) {
  $order = "INSERT INTO `orders`(`product_id`, `user_id`, `product_qty`, `order_amount`, `status`) 
    VALUES (" . $row['id'] . "," . $user_id . "," . $row['qty'] . "," . $row['price'] * $row['qty'] + 15000 . ", 'Đã xác nhận')";
      ...
      <div class="col-lg-8">
        <div class="breadcrumb_iner">
          <div class="breadcrumb_iner_item">
            ...
            <p>Trang chủ <span>-</span> Xác nhận đơn hàng</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="confirmation_tittle">
          <h1><span>Cảm ơn bạn. Đơn đặt hàng của hàng của bạn đã được nhận.</span></h1>
        </div>
      </div>
